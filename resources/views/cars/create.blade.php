    ...
    <div class="bg-white shadow-lg rounded-2xl w-full max-w-2xl p-8">
        ...
        <form action="{{ route('cars.store') }}" method="POST" class="space-y-4">
            ...
            <div class="flex items-center gap-2">
                <div class="w-16">
                    <input type="text" name="car_plate_part1" maxlength="2" placeholder="12" class="text-center w-full p-2 border border-gray-300 rounded-md" required>
                </div>
                <div class="w-20">
                ...
                <div class="w-20">
                    <input type="text" name="car_plate_part2" maxlength="3" placeholder="345" class="text-center w-full p-2 border border-gray-300 rounded-md" required>
                </div>
                <span class="font-bold text-lg px-2">ایران</span>
                <div class="w-16">
                    <input type="text" name="car_plate_part3" maxlength="2" placeholder="67" class="text-center w-full p-2 border border-gray-300 rounded-md" required>
                </div>
            </div>
            ...
            <div>
                ...
                <input type="text" name="car_model" class="w-full mt-1 p-2 border border-gray-300 rounded-md" required>
            </div>
            <div>
            ...
            <div>
                ...
                <input type="date" name="manufacture_year" class="w-full mt-1 p-2 border border-gray-300 rounded-md">
            </div>
            <div>
                <label class="block text-gray-700">تاریخ پایان همکاری:</label>
                <input type="date" name="collaboration_end_date" class="w-full mt-1 p-2 border border-gray-300 rounded-md">
            </div>
            <div>
            ...
            <div>
                ...
                <input type="text" name="owner_lsetname" class="w-full mt-1 p-2 border border-gray-300 rounded-md">
            </div>
            <div>
                <label class="block text-gray-700">شماره تلفن مالک:</label>
                <input type="text" name="owner_phonenumber" class="w-full mt-1 p-2 border border-gray-300 rounded-md">
            </div>
            <div>
                <label class="block text-gray-700">کد ملی مالک:</label>
                <input type="text" name="owner_nationl_id" class="w-full mt-1 p-2 border border-gray-300 rounded-md">
            </div>
            ...
            <div class="pt-4">
                <button type="submit" class="w-full bg-blue-700 hover:bg-blue-800 text-white py-2 px-4 rounded-md transition">ثبت خودرو</button>
            </div>
        </form>
    </div>
</main>
