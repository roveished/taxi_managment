            ...
            <table class="min-w-full bg-white border border-gray-200">
                <thead class="bg-gray-100 text-gray-700">
                    <tr>
                        ...
                        <th class="py-2 px-4 border-b text-center align-middle">شماره تلفن</th>
                        <th class="py-2 px-4 border-b text-center align-middle">وضعیت</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($inactiveDrivers as $driver)
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b text-red-600 font-bold text-center align-middle">{{ $driver->status }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
