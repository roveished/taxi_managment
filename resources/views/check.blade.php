...
<body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-10 mt-16 mb-20">
        ...
        <div class="flex items-center gap-2 mb-4">
          <div class="w-16">
              <input type="text" id="car_plate_part1" maxlength="2" placeholder="12" class="text-center w-full p-2 border border-gray-300 rounded-md" required>
          </div>
          <div class="w-20">
          ...
          <div class="w-20">
              <input type="text" id="car_plate_part2" maxlength="3" placeholder="345" class="text-center w-full p-2 border border-gray-300 rounded-md" required>
          </div>
          <span class="font-bold text-lg px-2">ایران</span>
          <div class="w-16">
              <input type="text" id="car_plate_part3" maxlength="2" placeholder="67" class="text-center w-full p-2 border border-gray-300 rounded-md" required>
          </div>
      
          <!-- دکمه جستجو -->
          <button id="searchButton" class="bg-blue-700 hover:bg-blue-800 text-white font-semibold px-4 py-2 rounded-lg transition">
              جستجو
          </button>
      </div>
        ...
        <section class="mb-10">
          ...
          <div class="flex flex-col gap-5">
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex gap-6 rtl:space-x-reverse">
                ...
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="front_glass" value="1" class="form-radio text-green-600 w-5 h-5" />
                  <span class="text-green-700 font-semibold select-none">قابل قبول</span>
                </label>
      
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="front_glass" value="0" class="form-radio text-red-600 w-5 h-5" />
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex gap-6 rtl:space-x-reverse">
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="rear_glass" value="1" class="form-radio text-green-600 w-5 h-5" />
                  <span class="text-green-700 font-semibold select-none">قابل قبول</span>
                </label>
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="rear_glass" value="0" class="form-radio text-red-600 w-5 h-5" />
                  <span class="text-red-700 font-semibold select-none">غیر قابل قبول</span>
                </label>
              </div>
            </div>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex gap-6 rtl:space-x-reverse">
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="toolbox" value="1" class="form-radio text-green-600 w-5 h-5" />
                  <span class="text-green-700 font-semibold select-none">قابل قبول</span>
                </label>
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="toolbox" value="0" class="form-radio text-red-600 w-5 h-5" />
                  <span class="text-red-700 font-semibold select-none">غیر قابل قبول</span>
                </label>
              </div>
            </div>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex gap-6 rtl:space-x-reverse">
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="first_aid_kit" value="1" class="form-radio text-green-600 w-5 h-5" />
                  <span class="text-green-700 font-semibold select-none">قابل قبول</span>
                </label>
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="first_aid_kit" value="0" class="form-radio text-red-600 w-5 h-5" />
                  <span class="text-red-700 font-semibold select-none">غیر قابل قبول</span>
                </label>
              </div>
            </div>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex gap-6 rtl:space-x-reverse">
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="spare_tire" value="1" class="form-radio text-green-600 w-5 h-5" />
                  <span class="text-green-700 font-semibold select-none">قابل قبول</span>
                </label>
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="spare_tire" value="0" class="form-radio text-red-600 w-5 h-5" />
                  <span class="text-red-700 font-semibold select-none">غیر قابل قبول</span>
                </label>
              </div>
            </div>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex gap-6 rtl:space-x-reverse">
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="front_tires" value="1" class="form-radio text-green-600 w-5 h-5" />
                  <span class="text-green-700 font-semibold select-none">قابل قبول</span>
                </label>
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="front_tires" value="0" class="form-radio text-red-600 w-5 h-5" />
                  <span class="text-red-700 font-semibold select-none">غیر قابل قبول</span>
                </label>
              </div>
            </div>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex gap-6 rtl:space-x-reverse">
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="rear_tires" value="1" class="form-radio text-green-600 w-5 h-5" />
                  <span class="text-green-700 font-semibold select-none">قابل قبول</span>
                </label>
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="rear_tires" value="0" class="form-radio text-red-600 w-5 h-5" />
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex gap-6 rtl:space-x-reverse">
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="front_lights" value="1" class="form-radio text-green-600 w-5 h-5" />
                  <span class="text-green-700 font-semibold select-none">قابل قبول</span>
                </label>
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="front_lights" value="0" class="form-radio text-red-600 w-5 h-5" />
                  <span class="text-red-700 font-semibold select-none">غیر قابل قبول</span>
                </label>
              </div>
            </div>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex gap-6 rtl:space-x-reverse">
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="rear_lights" value="1" class="form-radio text-green-600 w-5 h-5" />
                  <span class="text-green-700 font-semibold select-none">قابل قبول</span>
                </label>
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="rear_lights" value="0" class="form-radio text-red-600 w-5 h-5" />
                  <span class="text-red-700 font-semibold select-none">غیر قابل قبول</span>
                </label>
              </div>
            </div>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex gap-6 rtl:space-x-reverse">
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="front_fog_lights" value="1" class="form-radio text-green-600 w-5 h-5" />
                  <span class="text-green-700 font-semibold select-none">قابل قبول</span>
                </label>
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="front_fog_lights" value="0" class="form-radio text-red-600 w-5 h-5" />
                  <span class="text-red-700 font-semibold select-none">غیر قابل قبول</span>
                </label>
              </div>
            </div>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex gap-6 rtl:space-x-reverse">
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="rear_fog_lights" value="1" class="form-radio text-green-600 w-5 h-5" />
                  <span class="text-green-700 font-semibold select-none">قابل قبول</span>
                </label>
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="rear_fog_lights" value="0" class="form-radio text-red-600 w-5 h-5" />
                  <span class="text-red-700 font-semibold select-none">غیر قابل قبول</span>
                </label>
              </div>
            </div>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex gap-6 rtl:space-x-reverse">
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="brake_system" value="1" class="form-radio text-green-600 w-5 h-5" />
                  <span class="text-green-700 font-semibold select-none">قابل قبول</span>
                </label>
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="brake_system" value="0" class="form-radio text-red-600 w-5 h-5" />
                  <span class="text-red-700 font-semibold select-none">غیر قابل قبول</span>
                </label>
              </div>
            </div>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex gap-6 rtl:space-x-reverse">
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="mechanical_condition" value="1" class="form-radio text-green-600 w-5 h-5" />
                  <span class="text-green-700 font-semibold select-none">قابل قبول</span>
                </label>
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="mechanical_condition" value="0" class="form-radio text-red-600 w-5 h-5" />
                  <span class="text-red-700 font-semibold select-none">غیر قابل قبول</span>
                </label>
              </div>
            </div>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex gap-6 rtl:space-x-reverse">
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="cabin_appearance" value="1" class="form-radio text-green-600 w-5 h-5" />
                  <span class="text-green-700 font-semibold select-none">قابل قبول</span>
                </label>
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="cabin_appearance" value="0" class="form-radio text-red-600 w-5 h-5" />
                  <span class="text-red-700 font-semibold select-none">غیر قابل قبول</span>
                </label>
              </div>
            </div>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex gap-6 rtl:space-x-reverse">
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="body_appearance" value="1" class="form-radio text-green-600 w-5 h-5" />
                  <span class="text-green-700 font-semibold select-none">قابل قبول</span>
                </label>
                <label class="inline-flex items-center cursor-pointer gap-2">
                  <input type="radio" name="body_appearance" value="0" class="form-radio text-red-600 w-5 h-5" />
                  <span class="text-red-700 font-semibold select-none">غیر قابل قبول</span>
                </label>
              </div>
            </div>
